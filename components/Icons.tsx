...
export const SpeakerOffIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    fill="currentColor"
    className={className}>
    <path d="M13.5 4.06c0-1.336-1.616-2.005-2.56-1.06l-4.5 4.5H4.508c-1.141 0-2.318.664-2.66 1.905A9.76 9.76 0 001.5 12c0 .898.121 1.768.35 2.595.341 1.24 1.518 1.905 2.66 1.905H6.44l4.5 4.5c.944.945 2.56.276 2.56-1.06V4.06zM16.28 12c0-1.025.33-1.975.898-2.75l-1.06-1.06a4.5 4.5 0 00-5.83-1.21L7.14 9.123A9.728 9.728 0 004.508 9.75H4.5c-.802 0-1.54.462-1.845 1.18a9.723 9.723 0 000 2.14A9.712 9.712 0 004.5 15h.008c.706 0 1.382-.187 1.974-.515l2.14 2.14a4.5 4.5 0 006.92-5.078l-1.06-1.06A3.011 3.011 0 0116.28 12z" />
